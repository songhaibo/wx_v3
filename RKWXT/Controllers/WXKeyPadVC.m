...
//	UIColor *normalColor = WXColorWithInteger(0xffffff);
	...
	_rightButton = [[WXUIButton buttonWithType:UIButtonTypeCustom] retain];
	...
	_leftButton = [[WXUIButton buttonWithType:UIButtonTypeCustom] retain];
...
- (CallHistoryCell*)callHistoryCellAtRow:(NSInteger)row{
    ...
    if(!cell){
        cell = [[[CallHistoryCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:callHistoryCellIdentifier] autorelease];
    }
...
- (SimpleContacterCell*)contactCellAtRow:(NSInteger)row{
    ...
    if(!cell){
        cell = [[[SimpleContacterCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:identifier] autorelease];
    }
    [cell setBaseDelegate:self];
